locals {
  sles_startup_script_template_file      = "templates/sles_startup_script_sh.tpl"
  sles_startup_script_file               = "${path.cwd}/sles_startup_script.sh"
  disk_structure                         = "97"
  data_disk_name                         = "/dev/sd"
  data_disk_mount_point                  = "/mnt/datadisk"
  default_ipxe_script_template_file      = "templates/default_ipxe.tpl"
  default_ipxe_script_file               = "${path.cwd}/default.ipxe"
  ipxe_base_url                          = "http://192.168.122.1"
  create_cloud_config_template_file      = "templates/create_cloud_config_yaml.tpl"
  create_cloud_config_file               = "${path.cwd}/create_cloud_config.yaml"
  join_cloud_config_template_file        = "templates/join_cloud_config_yaml.tpl"
  join_cloud_config_file                 = "${path.cwd}/join_cloud_config.yaml"
  harvester_startup_script_template_file = "templates/harvester_startup_script_sh.tpl"
...
module "harvester_node" {
  ...
  hv_node_count        = var.harvester_node_count
}
